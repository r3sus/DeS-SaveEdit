...
Public Class DeS
    ...
    Public Shared TEMP_FILE_NAME, SELECTED_SAVE_FILE_NAME
    Public Shared modified = False
    Public Shared manager As Ps3SaveManager
    Public Shared Ps3File0 As Ps3File
    ...
    Private Sub btnDeSOpen_Click(sender As System.Object, e As System.EventArgs) Handles btnDeSOpen.Click
        ...
        'dec = File.Exists(folder & "\" & "PARAM.SFO")
        'crp = Not dec
        ...
        Try
            ...
            Else
                ...
                Ps3File0 = manager.Files.FirstOrDefault(Function(t) t.PFDEntry.file_name = SELECTED_SAVE_FILE_NAME)
                bytes = Ps3File0.DecryptToBytes
...
#Region "(disabled) write (last/active?) slot # to SFO"

            If False Then


                TEMP_FILE_NAME = "PARAM.SFO"
                bytes = System.IO.File.ReadAllBytes(txtDeSFolder.Text & "\" & TEMP_FILE_NAME)
                bytes(&H570) = Val(txtProfNum.Text) 'offset might vary in RPCS3
                System.IO.File.WriteAllBytes(txtDeSFolder.Text & "\" & TEMP_FILE_NAME, bytes)
...
#End Region
            ...
            If crp Then
                ...
                bytes = Ps3File0.DecryptToBytes
            Else
                bytes = System.IO.File.ReadAllBytes(folder & "\" & SELECTED_SAVE_FILE_NAME)
            End If
...
#End Region
            ...
            If crp Then
                Ps3File0.Encrypt(bytes)
                manager.ReBuildChanges()
            Else
                System.IO.File.WriteAllBytes(txtDeSFolder.Text & "\" & SELECTED_SAVE_FILE_NAME, bytes)
            End If

#Region "(disabled) write unicode name to 104USER.DAT"
            If False Then

                TEMP_FILE_NAME = "104USER.DAT"
                If crp Then
                    Ps3File0 = manager.Files.FirstOrDefault(Function(t) t.PFDEntry.file_name = TEMP_FILE_NAME)
                    bytes = Ps3File0.DecryptToBytes
                Else
                    bytes = System.IO.File.ReadAllBytes(folder & "\" & TEMP_FILE_NAME)
                End If
...
#End Region
    ...
    Private Sub txtDeSFile_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtDeSFolder.TextChanged
        ...
        Next
        ComboBox1.Text = "SELECT SAVE FILE"
...
Handles dgvSpells.DefaultValuesNeeded
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        SELECTED_SAVE_FILE_NAME = ComboBox1.SelectedItem.ToString()
